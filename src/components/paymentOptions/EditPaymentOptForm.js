...
function EditPaymentOptForm() {
  ...
  const { selectedPaymentOpt } = useSelector((state) => state.paymentOptions);

  useEffect(() => {
    setForm(selectedPaymentOpt);
...
const newObj={...form, url}

    dispatch(addPaymentOptions(newObj));
  };
        ...
        <Row className="d-flex  align-items-center">
          ...
          { form.url && form.url!=='' ? (
             ...
             <div className="position-relative p-2 border image-container">
               <img src={form.url} alt="" width="150px" />
